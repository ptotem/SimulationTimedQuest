...
ActiveRecord::Schema.define(version: 20150708132951) do

  create_table "game_statuses", force: :cascade do |t|
    t.integer  "user_id",         limit: 4
    t.boolean  "mcq",             limit: 1, default: false
    t.boolean  "msq",             limit: 1, default: false
    t.boolean  "quinterrogation", limit: 1, default: false
  ...
  create_table "user_results", force: :cascade do |t|
    ...
    t.text     "selected_option", limit: 65535
    t.text     "correct_option",  limit: 65535
    t.text     "option_status",   limit: 65535
    t.float    "option_score",    limit: 24,    default: 0.0
    t.datetime "created_at",                                  null: false
    t.datetime "updated_at",                                  null: false
  end
